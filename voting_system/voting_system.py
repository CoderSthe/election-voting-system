...
def display_ballot_choice() -> None:
...
def register_candidate():
    ...
    for i in range(reg_num):
        ...
        user_choice = int(input())
        assert user_choice in {1,2}, "Invalid selection made."

        ballot_contest = 'Provincial' if user_choice == 1 else 'National'
        print()
